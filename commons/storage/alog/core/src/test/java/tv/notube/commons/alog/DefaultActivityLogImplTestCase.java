...
public class DefaultActivityLogImplTestCase {
    ...
    public void setUp() throws ActivityLogException {
        ...
        properties.setProperty("url", "jdbc:mysql://127.0.0.1:3306/tv.notube.commons.tv.notube.commons.alog");
        properties.setProperty("username", "tv.notube.commons.tv.notube.commons.alog");
        properties.setProperty("password", "tv.notube.commons.tv.notube.commons.alog");
